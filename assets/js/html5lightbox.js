        ...
        $.fn.html5lightbox = function (options) {
            ...
            inst.createMarkup = function () {
                ...
                if (
                    ...
                    styleCss +=
                        "#html5box-html5-lightbox .html5-prev-touch {left:40px;top:50%;margin-top:-16px;margin-left:-32px;} #html5box-html5-lightbox .html5-next-touch {right:40px;top:50%;margin-top:-16px;margin-right:-32px;}";
                    styleCss +=
                        "@media (max-width: " +
                ...
                inst.$lightbox = $(
                    "<div id='html5box-html5-lightbox' style='display:none;top:0px;left:0px;width:100%;height:100%;z-index:999999999999999999;text-align:center;'>" +
            ...
            inst.calcElemSize = function (sizeObj, keepratio) {
                ...
                if (inst.currentElem && inst.currentElem[ELEM_TYPE] == 0) {
                    // For images (type 0), use fixed dimensions
                    var fixedWidth = 500; // Set your desired fixed width
                    var fixedHeight = 500; // Set your desired fixed height

                    return { w: fixedWidth, h: fixedHeight };
                }

                // For other content types, use the original responsive calculation
